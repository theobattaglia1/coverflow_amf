...
// Fetch cover data and initialize
...
function renderCovers() {
  ...
  covers.forEach((cover, i) => {
    ...
    if (cover.albumTitle?.toLowerCase() === "contact") {
      ...
      labelBack.innerHTML = labelFront.innerHTML;
...
// Enhanced kinetic scroll handling
let scrollVelocity = 0;
let scrollTarget = activeIndex;
...
function animateScroll() {
  ...
  setActiveIndex(Math.round(scrollTarget));
